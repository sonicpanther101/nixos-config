  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        # switch workspace
        "$mainMod, 1, workspace, e~1"
        "$mainMod, 2, workspace, e~2"
        "$mainMod, 3, workspace, e~3"
        "$mainMod, 4, workspace, e~4"
        "$mainMod, 5, workspace, e~5"
        "$mainMod, 6, workspace, e~6"
        "$mainMod, 7, workspace, e~7"
        "$mainMod, 8, workspace, e~8"
        "$mainMod, 9, workspace, e~9"
        "$mainMod, 0, workspace, e~10"

        # same as above, but switch to the workspace
        "$mainMod SHIFT, 1, movetoworkspacesilent, e~1"
        "$mainMod SHIFT, 2, movetoworkspacesilent, e~2"
        "$mainMod SHIFT, 3, movetoworkspacesilent, e~3"
        "$mainMod SHIFT, 4, movetoworkspacesilent, e~4"
        "$mainMod SHIFT, 5, movetoworkspacesilent, e~5"
        "$mainMod SHIFT, 6, movetoworkspacesilent, e~6"
        "$mainMod SHIFT, 7, movetoworkspacesilent, e~7"
        "$mainMod SHIFT, 8, movetoworkspacesilent, e~8"
        "$mainMod SHIFT, 9, movetoworkspacesilent, e~9"
        "$mainMod SHIFT, 0, movetoworkspacesilent, e~10"
