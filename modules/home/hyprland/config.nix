  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      bind = [
        ...
        # switch workspace
        "$mainMod, 1, workspace, m~1"
        "$mainMod, 2, workspace, m~2"
        "$mainMod, 3, workspace, m~3"
        "$mainMod, 4, workspace, m~4"
        "$mainMod, 5, workspace, m~5"
        "$mainMod, 6, workspace, m~6"
        "$mainMod, 7, workspace, m~7"
        "$mainMod, 8, workspace, m~8"
        "$mainMod, 9, workspace, m~9"
        "$mainMod, 0, workspace, m~10"

        # same as above, but switch to the workspace
        "$mainMod SHIFT, 1, movetoworkspacesilent, m~1"
        "$mainMod SHIFT, 2, movetoworkspacesilent, m~2"
        "$mainMod SHIFT, 3, movetoworkspacesilent, m~3"
        "$mainMod SHIFT, 4, movetoworkspacesilent, m~4"
        "$mainMod SHIFT, 5, movetoworkspacesilent, m~5"
        "$mainMod SHIFT, 6, movetoworkspacesilent, m~6"
        "$mainMod SHIFT, 7, movetoworkspacesilent, m~7"
        "$mainMod SHIFT, 8, movetoworkspacesilent, m~8"
        "$mainMod SHIFT, 9, movetoworkspacesilent, m~9"
        "$mainMod SHIFT, 0, movetoworkspacesilent, m~10"
